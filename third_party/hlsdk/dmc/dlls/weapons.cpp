...
void CBasePlayerWeapon::ItemPostFrame( void )
{
	...
	{
		// complete the reload. 
		int j = oldmin( iMaxClip() - m_iClip, m_pPlayer->m_rgAmmo[m_iPrimaryAmmoType]);	
...
BOOL CBasePlayerWeapon :: AddPrimaryAmmo( int iCount, char *szName, int iMaxClip, int iMaxCarry )
{
	...
	{
		int i;
		i = oldmin( m_iClip + iCount, iMaxClip ) - m_iClip;
		m_iClip += i;
...
BOOL CBasePlayerWeapon :: DefaultReload( int iClipSize, int iAnim, float fDelay )
{
	...
	int j = oldmin(iClipSize - m_iClip, m_pPlayer->m_rgAmmo[m_iPrimaryAmmoType]);	
